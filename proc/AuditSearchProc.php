...
$StDate=stripslashes(mysql_real_escape_string($_POST['StDate']));
$EnDate=stripslashes(mysql_real_escape_string($_POST['EnDate']));
$Admin=stripslashes(mysql_real_escape_string($_POST['Admin']));
$Object=stripslashes(mysql_real_escape_string($_POST['Object']));
if (!empty($Admin)) $Admin= "and AID=".$Admin; else $Admin=' ';
if (!empty($Object)) $Object= " and Object='".$Object."'"; else $Object= ' ';
if (!empty($StDate)) $StDate=" Date >='".$StDate."'"; else $StDate=" Date >= '0000-00-00 00:00:00' ";
if (!empty($EnDate)) $EnDate=" Date <='".$EnDate."'"; else $EnDate=" Date <= '9999-99-99 23:59:59' "; 
$query="select * from Audit where ".$StDate." and ".$EnDate.$Admin.$Object." order by ".$Order." ".$DE;
