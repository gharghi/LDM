...
<form id="Hardware" method="post" class="search_form general_form">
 ...
 <fieldset>
  ...
  <div class="addicon" onClick="OpenAddHardware(this);"> <img src="css/layout/addobject.png"  title="افزودن سخت افزار "> </div>
  <div id="AddHardware" style="display:none;"> 
...
$result1=mysql_query($query1);
$num2=mysql_num_rows($result1);
echo "<select name='TWID' onchange='FillSwitch(this);'> <option>انتخاب کنید</option>";
	$i=0;
	while ($i < $num2) 
		{
...
?>
    ...
    <div class="row" style="display:none;" id="SW"> </div>
    
    <!--[if !IE]>end row<![endif]--> 
    
    <!--[if !IE]>start row<![endif]-->
    
    <div class="row" style="display:none;" id="PortN"> </div>
    ...
    <div class="row">
     <div class="inputs"> <span class="button2 blue_button add_button"><span><span><span class="button_ico"></span><em>تایید</em></span></span>
      <input name="submit" type="submit" onclick="AddHardware(this); return false;"/>
...
<!--[if !IE]>start section inner<![endif]-->
<div class="section_inner" id="tablehardware"> </div>
