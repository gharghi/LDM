...
<div class="section_inner">
      ...
      <div class="row">
        ...
        <div class="inputs">
          <div align="right"><span class="view_wrapper">
            <input class="inputview" id="<?php echo $FID.'1'; ?>" name="Hostname" type="text" readonly value="<?php echo $Hostname; ?>" onclick="EditInline(this,'<?php echo $FID.'1'; ?>'); return false;"/>
  ...
  <!--[if !IE]>end row<![endif]--> 
      ...
      <div class="row">
        ...
        <div class="inputs">
          <div align="right"><span class="view_wrapper">
            <input class="inputview" id="<?php echo $FID.'6'; ?>" name="MAC" type="text" readonly value="<?php if (empty($MAC)) echo $empty; else echo $MAC; ?>" onclick="NEditInline(this,'<?php echo $FID.'6'; ?>'); return false;"/>
      ...
      <div class="row">
        ...
        <div class="inputs">
          <div align="right"><span class="view_wrapper">
            <input class="inputview" id="<?php echo $FID.'22'; ?>" name="VLAN" type="text" readonly value="<?php if (empty($VLAN)) echo 0; else echo $VLAN; ?>" onclick="NEditInline(this,'<?php echo $FID.'22'; ?>'); return false;"/>
